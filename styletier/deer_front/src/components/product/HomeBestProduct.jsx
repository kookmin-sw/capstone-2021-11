...
const useStyles = makeStyles({
  ...
  export default function HomeBestProduct(props) {
    ...
    let content = props.best.content;
          ...
          return(
            ...
            <Grid container className={classes.Grid}>
              <Grid style={{width:'50%',}}>
                ...
                <Button component={Link} to={`/shop/${props.best.id}`} className={classes.bestBtn} onClick={ () =>window.scrollTo(0,0)}>
              ...
              <Grid className={classes.textGrid} >
                ...
                <Typography className={classes.bestText} style={{fontSize: 18, marginTop: '45%',}}>
                  {props.best.name}<br/>
                  {props.best.category}
                </Typography>
              </Grid>
